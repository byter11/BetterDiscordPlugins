...
module.exports = class SoundBoard {
  ...
  gg = `
  <div class="select-2TCrqx">
          <div class="css-gvi9bl-control">
            <div class="css-1hwfws3">
              <div class="css-4h5swf-singleValue">
                <span class="deviceOption-o4yLlI">
                  <span class="deviceOptionLabel-22FM_u">
                    Microphone (2- USB Audio Device)
                  </span>
                </span>
              </div>
              <input id="react-select-58-input" readonly="" tabindex="0" class="css-gj7qu5-dummyInput" value="">
            </div>
